...
- New code should follow the tidyverse [style
  guide](http://style.tidyverse.org) except where that readily conflicts
  with existing code. PKNCA is moving (slowly) toward more
  tidyverse-like styling. You can use the
