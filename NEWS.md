...
* Documentation fix: runtime description strings that contradicted the
  ...
  `aucint.inf.obs`, `aucint.inf.pred`, `aumcint.inf.obs`, `aumcint.inf.pred`,
  and their `.dose` variants (they extrapolate using the half-life and the
  observed/predicted Clast rather than the AUClast/AUCall and
  AUMClast/AUMCall rules) (#582).
