...
When dosing data are given, it stops at the doses on either side of the interval, so a concentration measured after the next dose is not interpolated back into the interval (e.g. a dose at 24 hours but the prior sample is around 12 and the next is around 25):
