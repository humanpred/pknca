...
* `start_predose` shifts the most recent observation before the interval start
  ...
  exists, only when a pre-start observation with a measured concentration
  exists, and only when the shift is no more than `max_shift` (by default, 5%
  of the interval duration or, for intervals with an infinite end, 5% of the
