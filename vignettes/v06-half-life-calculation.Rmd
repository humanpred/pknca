...
![Decision tree for choosing between automatic curve stripping, `exclude_half.life`, and `include_half.life`.](v06-half-life-calculation_decision_tree.svg)
...
* Only `include_half.life` turns off automatic selection.  `exclude_half.life`
  ...
  rest, so `min.hl.points`, `allow.tmax.in.half.life`, and
  `adj.r.squared.factor` still apply to the points that remain.
