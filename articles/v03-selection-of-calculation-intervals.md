...
| aumcivall             | aumc                     | AUMCall with back-extrapolation using extrapolated C0 for IV dosing                                                                                                                                                                                                                                                                                           | pk.calc.aumciv                         |
| aumcivinf.obs         | aumc                     | AUMCinf,obs with back-extrapolation using extrapolated C0                                                                                                                                                                                                                                                                                                     | pk.calc.aumciv                         |
| aumcivinf.pred        | aumc                     | AUMCinf,pred with back-extrapolation using extrapolated C0                                                                                                                                                                                                                                                                                                    | pk.calc.aumciv                         |
...
| aumcivlast            | aumc                     | AUMClast with back-extrapolation using extrapolated C0 for IV dosing                                                                                                                                                                                                                                                                                          | pk.calc.aumciv                         |
...
| cl.sparse.last        | clearance                | Clearance from sparse sampling calculated with population AUClast                                                                                                                                                                                                                                                                                             | pk.calc.cl                             |
...
| kel.sparse.last       | inverse_time             | Elimination rate (as calculated from the MRTsparse.last)                                                                                                                                                                                                                                                                                                      | pk.calc.kel                            |
...
| mrt.sparse.last       | time                     | Mean residence time from sparse sampling                                                                                                                                                                                                                                                                                                                      | pk.calc.mrt                            |
